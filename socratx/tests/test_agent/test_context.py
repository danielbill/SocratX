...
# =============================================================================
# TestContextBuilderBuild - 构建上下文测�?
# =============================================================================


class TestContextBuilderBuild:
    """ContextBuilder 构建上下文测�?""
...
# =============================================================================
# TestContextBuilderSystemPrompt - 系统提示词测�?
# =============================================================================


class TestContextBuilderSystemPrompt:
    """ContextBuilder 系统提示词测�?""
...
class TestContextBuilderEdgeCases:
    ...
    async def test_build_truncates_long_messages(self, temp_workspace):
        ...
        # 应该只保留最�?50 �?+ system 消息
        assert len(result) == 51  # 50 条历�?+ 1 �?system
...
# =============================================================================
# TestContextBuilderConfig - 配置类测�?
# =============================================================================


class TestContextBuilderConfig:
    """ContextBuilderConfig 配置类测�?""
